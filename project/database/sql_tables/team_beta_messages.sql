...
CREATE TABLE `messages` (
  ...
  KEY `fk_messages_projects1_idx` (`projects_id`),
  CONSTRAINT `fk_messages_projects1` FOREIGN KEY (`projects_id`) REFERENCES `projects` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
